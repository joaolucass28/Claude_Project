            ...
            >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    ...
                    {isMobile && (
                        ...
                        >
                            <span style={{ display: "block", width: 22, height: 2, background: C.graphite, borderRadius: 1, transition: "transform 250ms ease, opacity 250ms ease", transform: menuOpen ? "rotate(45deg) translate(5px, 5px)" : "none" }} />
                            <span style={{ display: "block", width: 22, height: 2, background: C.graphite, borderRadius: 1, transition: "opacity 250ms ease", opacity: menuOpen ? 0 : 1 }} />
                            <span style={{ display: "block", width: 22, height: 2, background: C.graphite, borderRadius: 1, transition: "transform 250ms ease", transform: menuOpen ? "rotate(-45deg) translate(5px, -5px)" : "none" }} />
                        </button>
                    )}
...
function Hero() {
    ...
    return (
        ...
        >
            {/* Solid dark base — always covers the full hero */}
            <div
                style={{
                    position: "absolute",
                    inset: 0,
                    background: "linear-gradient(160deg, #2A3D2E 0%, #3a5232 60%, #4a6741 100%)",
                }}
            />

            {/* Right-side image — occupies right portion only */}
            {heroImage && (
                <div
                    style={{
                        position: "absolute",
                ...
                >
                    {/* Gradient fade from dark base into the image */}
                    <div
                        style={{
                            position: "absolute",
                            inset: 0,
                            background: isMobile
                                ? "linear-gradient(to right, #2A3D2E 0%, rgba(42,61,46,0.5) 45%, transparent 100%)"
                                : "linear-gradient(to right, #2A3D2E 0%, rgba(42,61,46,0.4) 35%, transparent 100%)",
                        }}
                    />
                </div>
            )}
            ...
            <div
                style={{
                    position: "absolute",
                    inset: 0,
                    background: "linear-gradient(to top, rgba(15,22,15,0.72) 0%, rgba(15,22,15,0.2) 55%, transparent 100%)",
                }}
            />
            ...
            <div
                style={{
                    ...
                    zIndex: 2,
                    maxWidth: 760,
                    padding: isMobile ? "0 24px 72px" : "0 80px 96px",
                    boxSizing: "border-box",
                }}
            >
                <motion.p
...
// ─── GLEBA CARD ───────────────────────────────────────────────
function GlebaCard({ name, area, price, description, delay = 0, bg, imgSrc }) {
    const [hov, setHov] = useState(false)
    const ref = useRef(null)
...
function Brumadinho() {
    ...
    const items = [
        {
            ...
            desc: "A aproximadamente 40 km de Belo Horizonte, com acesso por rotas asfaltadas e consolidadas.",
        },
        {
            title: "Município consolidado",
            desc: "Brumadinho conta com comércio, serviços de saúde e infraestrutura urbana a poucos minutos das glebas.",
        },
        {
            title: "Natureza preservada",
            desc: "Região de mata atlântica e cerrado, com paisagem visual expressiva e qualidade ambiental reconhecida.",
        },
    ]
    ...
    return (
        <Section id="brumadinho" bg={C.surface}>
            ...
            >
                {/* Left image — natural aspect ratio, no cropping */}
                <div
                    style={{
                        borderRadius: 4,
                        overflow: "hidden",
    ...
    return (
        <Section id="contato" bg={C.light}>
            <div ref={ref} style={{ textAlign: "center", maxWidth: 640, margin: "0 auto" }}>
                ...
                <SectionHeading center>Tem interesse em alguma gleba?</SectionHeading>
                <motion.p
                    initial="hidden"
                    animate={inView ? "visible" : "hidden"}
                    variants={fadeUp}
                ...
                >
                    Entre em contato para receber o memorial descritivo completo,
                    documentação disponível e agendar uma visita às propriedades.
                </motion.p>
                <motion.div
                    initial="hidden"
                    animate={inView ? "visible" : "hidden"}
                ...
                >
                    <BtnPrimary href="https://wa.me/YOUR_WHATSAPP_NUMBER?text=Ol%C3%A1%2C+tenho+interesse+nas+Glebas+Rurais">
                        Falar pelo WhatsApp
                    </BtnPrimary>
                    <BtnOutline href="mailto:YOUR_EMAIL">
                        Enviar e-mail
                    </BtnOutline>
                </motion.div>
            </div>
...
function Footer() {
    ...
    return (
        <footer style={{ background: C.forest, padding: isMobile ? "64px 24px 32px" : "80px 48px 40px", boxSizing: "border-box" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                ...
                >
                    ...
                    >
                        © 2026 Glebas Rurais. Brumadinho, MG.
                    </p>
                    <p
                        style={{
                            fontFamily: SANS,
...
// ─── ROOT COMPONENT ──────────────────────────────────────────
export default function GlebasRurais({ heroImage, glebaAImage, glebaBImage, glebaCImage, mapaImage }) {
    return (
        <ImageContext.Provider value={{ heroImage, glebaAImage, glebaBImage, glebaCImage, mapaImage }}>
            <div
                style={{
                    fontFamily: SANS,
                    background: C.base,
